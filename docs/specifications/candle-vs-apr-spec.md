...
| F-FORMAT-01 | APR v2 load 2-5x faster than GGUF | APR v2 load <1.5x faster | **BLOCKED** | Standard APR (F32) correct. Q4K APR garbage — pool allocator offset/alignment mismatch (paiml/realizar#170). 0 provable-contracts on tensor name resolution. |
...
| PMAT-333 | realizr APR v2 Q4K decode | BLOCKED | Standard APR F32 correct. Q4K pool offset mismatch (#170). 0 contracts. |
